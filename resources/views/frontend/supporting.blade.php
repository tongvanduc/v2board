...
<head>
    ...
    <title>CrowVPN - 全球最佳十大VPN之一</title>
    <meta property="og:type" content="website">
    <link rel="icon" type="image/png" href="{{ asset('frontend/img/logo.png') }}">
    <link rel="stylesheet" href="{{ asset('frontend/css/bootstrap_sp.min.css') }}">
    ...
    <div class="header-blue">
        <header class="">
            ...
            <nav class="navbar navbar-expand-lg navbar-expand-xxl navbar-light bg-white z-index-3 py-3  shadow">
                <div class="container">
                    <a class="navbar-brand" href="{{ route('frontend.index') }}" rel="tooltip" title="Code by Minh Duc Designer"
                       data-placement="bottom" target="_blank">
                        <img src="{{ asset('frontend/img/logo/logo%202.svg') }}" alt="logo" class="logo img-fluid">
                    </a>
                    <button class="btn bg-gradient-green btn btn-sm   mb-0 ms-auto d-lg-none d-block mb-0 w-91">帮助
                    </button>
                    ...
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                        <ul class="navbar-nav navbar-nav-hover ml-auto">
                            ...
                            <li class="nav-item px-3">
                                <a href="{{ route('frontend.supporting') }}" class="nav-link">
                                    支持的网站
                                </a>
                            </li>
        ...
        <div class="container hero">
            ...
            <div class="row align-items-center">
                ...
                <div class="col col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    ...
                    <p class="line-p">欢迎提交更精彩的网址给到我们 <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                                        data-cfemail="c0b3a5b2b6a5b280a3b2afb7b6b0aeeea3afad">[email&#160;protected]</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center five-g">
                <div class="col col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" style="padding: 15px;">
                    <div class="box five-div"><img class="five-img" src="{{ asset('frontend/img/4.png') }}"></div>
                </div>
...
<div class="footer-dark">
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-6" style="padding-bottom: 15px;"><img class="logo-big" src="{{ asset('frontend/img/logo.png') }}">
                    <h3><img src="{{ asset('frontend/fonts/logo_text.svg') }}"></h3>
                    <p class="footer-logo-h2" style="color: #75777b;">韩国十年老牌 VPN 技术团队研发<br>安全、高速、易用的加密 VPN</p>
                </div>
                <div class="col col-sm-4 col-md-2 item">
                    <div>
                        <h3>CrowVPN</h3>
                        <ul>
                            <li><a href="index.html">我们的优势？</a></li>
                            <li><a href="web.html">支持网站</a></li>
                            <li><a href="shop.html">定价</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col col-sm-4 col-md-2 item">
                ...
                <div class="col col-sm-4 col-md-2 item">
                    <div>
                        <h3>支持</h3>
                        <ul>
                            <li><a href="https://docs.crowvpn.com" target="_blank">帮助中心</a></li>
                            <li><a href="/terms.html">隐私政策</a></li>
                            <li><a href="/affiliates.html">我要加盟</a></li>
                            <li><a href="https://t.me/crownew" target="_blank">Telegram</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <p class="copyright">我们在意您的隐私安全。 版权所有© 2012-2020 CrowVpn.com </p>
        </div>
    </footer>
</div>
